...
<body>
	<div class="fix full div_mid">
		<?php include('layouts/vendor_panel_head.php'); ?>
		
		<div class="fix full">
			<?php include('layouts/vendor_panel_left_menu.php'); ?>	
			
			<div class="fix floatleft eighty_percent pt_10 pr_10 pb_10 pl_10 border_box">
				<div class="fix full">
					<div class="fix half floatleft"><h1 class="fs_30 lh_40 font_bold text_dark_ash mb_10 pl_5 pr_5">Client History</h1></div>
