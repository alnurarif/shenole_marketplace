                ...
                <div class="content-container-center">
                    <div class="profile-section" id="messages">
                            ...
                            <form action="" class="full-width-form">
                                <div class="form-input-container">
                                    <div class="form-input-search">
                                        <label for="keywords" class="input-label">Comma Separated Keywords or Client Username</label>
                                        <div class="spacer-10px"></div>
                                        <div>
                                            <input type="text" id="keyword-vendor-search" class="search-input" placeholder="JohnnyBoy123">
                                        </div>
                                    </div>
                        ...
                        <div class="message-screen">
                            ...
                            <div class="message-container">
                                ...
                                <div class="message-display-body">
                                    <h3 class="primary-text">Client Username</h3>
                        ...
                        <form action="" class="full-width-form">
                            <div class="spacer-10px"></div>
                            <div class="spacer-10px"></div>
                            <h3>Message To Clients</h3>
                            <div class="form-input-container">
                                <div class="form-input-search">
                                    <label for="keywords" class="input-label">Enter Recipient Client</label>
                                    <div class="spacer-10px"></div>
                                    <div>
                                        <input type="text" id="keyword-vendor-search" class="search-input" placeholder="example: johnsmith@email.com">
                                    </div>
                                    <div class="spacer-10px"></div>
                                    <div class="form-input-select">
                                    ...
                                    <div class="spacer-10px"></div>
                                    <div class="form-submit-container">
                                        <a href="" class="button-03 button-link-text white-text">Find Client</a>
                                    </div>
                                </div>
                                <div class="form-input-search">
                                    <label for="location" class="input-label">Client List</label>
                                    <div class="spacer-10px"></div>
                            ...
                            <h3>Message going to CLIENT USERNAME HERE</h3>
