...
if(isset($_POST['login'])){
	$found_email = Staff::where('email', '=', $_POST['email'])->exists(); 
	$found_password = Staff::where('email', '=', $_POST['email'])->where('password', '=', $_POST['password'])->exists();
	...
	if($errors['errors_number'] == 0){
		$user = Staff::where('email', '=', $_POST['email'])->where('password', '=', $_POST['password'])->first();
